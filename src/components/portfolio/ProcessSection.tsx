  ...
  return (
    ...
    >
      <div className="relative group/section">
        ...
        <div className="relative grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 text-center">
          {portfolioData.developmentProcess.map((step, index) => (
            <div key={step.title} className="relative flex flex-col items-center gap-4 group animate-in fade-in-up" style={{ transitionDelay: `${index * 100}ms` }}>
